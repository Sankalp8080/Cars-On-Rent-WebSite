...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function sendMessage(s, e) {
            ...
            var comment = $('#<%= txtMessage.ClientID %>').val();
            debugger;
            if (name != '' && email != '' && phone != '' && comment != '') {
                $.ajax({
                    url: "http://localhost:5133/api/UserContact/usercontact",
                    type: "POST",
                    ...
                    success: function (response) {
                        ...
                        if (response == "1") {
                            ...
                            alert("Your response is already reached !!!");
                        }
                    },
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mail_section_1">
                                            ...
                                            <div class="row pt-2">
                                                <dx:ASPxButton ID="btnSend" runat="server" Text="Send" CssClass="btn send_bt" ClientInstanceName="cbdClear" TabIndex="4">
                                                    <ClientSideEvents Click="sendMessage" />
                                                </dx:ASPxButton>
                                            </div>
